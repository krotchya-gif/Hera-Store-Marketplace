  ...
  return (
    ...
    >
            ...
            <div className="px-4 pb-4 border-b border-gray-100">
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span className="text-xs font-semibold text-green-700">{user ? "Akun Saya" : "Masuk / Daftar"}</span>
                </Link>
                <Link
      ...
      <a
        ...
        className="fixed bottom-20 right-4 md:bottom-6 md:right-6 z-50 flex items-center gap-1.5 bg-green-500 text-white pl-2.5 pr-3 py-2 rounded-full shadow-lg hover:bg-green-600 transition-all hover:scale-105 animate-pulse"
      >
        ...
        <span className="text-[11px] md:text-xs font-semibold whitespace-nowrap">Hubungi Admin</span>
      </a>
