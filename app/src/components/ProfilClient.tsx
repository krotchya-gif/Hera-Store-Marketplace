      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1 min-w-0">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 text-center">
                    <p className="text-xl font-bold text-green-700">
                      {formatRp(orders.reduce((s, o) => s + o.total, 0))}
                    </p>
                    <p className="text-sm text-gray-500 mt-1">Total Belanja</p>
                  </div>
                  <div className="col-span-2 md:col-span-1 bg-white rounded-2xl border border-gray-100 shadow-sm p-4 text-center">
            ...
            {/* Alamat Tab */}
            {activeTab === "alamat" && <AddressManager userId={user!.id} />}
